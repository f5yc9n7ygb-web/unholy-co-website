...
const CHAPTERS = [
  {
    ...
    status: "UNLOCKED",
    blurb: "3:33 AM. Mumbai. You crack open a can of BloodThirst — and the can answers back.",
  ...
  },
  {
    ...
    status: "LOCKED",
    blurb: "They drank. The city screamed. Unlocks with Drop 02.",
    href: "/bloodverse",
    x: 70,
    y: 45,
    symbol: "♆",
  },
  {
    ...
    status: "LOCKED",
    blurb: "The final sip. The first truth. Unlocks with Drop 03.",
    href: "/bloodverse",
    x: 40,
    y: 60,
    symbol: "⛧",
